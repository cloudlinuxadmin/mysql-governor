...
############################################
Source202: mysql_config_multilib.sh
Source203: my.cnf.in
Source205: README.mysql-cnf
Source210: mysql.tmpfiles.d.in
Source211: mysql.service.in
Source212: mysql-prepare-db-dir.sh
Source213: mysql-wait-ready.sh
Source214: mysql-check-socket.sh
Source215: mysql-scripts-common.sh
Source216: mysql-compat.service.in
Source217: mysql-compat.conf.in
Source218: mysql.init.in
Source251: rh-skipped-tests-intel.list
Source253: rh-skipped-tests-ppc-s390.list
Source254: rh-skipped-tests-ppc64le.list

# Patches from CloudLinux
Patch100: max_connection2_mariadb_10_1_1_b409.patch
...
%ifarch x86_64 i686
cat %{SOURCE251} >> mysql-test/rh-skipped-tests.list
%endif

%ifarch ppc ppc64 ppc64p7 s390 s390x
cat %{SOURCE253} >> mysql-test/rh-skipped-tests.list
%endif

%ifarch ppc64le
cat %{SOURCE254} >> mysql-test/rh-skipped-tests.list
%endif

cp %{SOURCE202} %{SOURCE203} %{SOURCE210} %{SOURCE211} %{SOURCE212} %{SOURCE213} \
   %{SOURCE214} %{SOURCE215} %{SOURCE216} %{SOURCE217} %{SOURCE218} scripts
...
cp %{SOURCE205} README.mysql-cnf
cp %{SOURCE216} mysql-compat.service.in
...
%{_datadir}/doc/COPYING
%{_datadir}/doc/COPYING.LESSER
%{_datadir}/doc/CREDITS
%{_datadir}/doc/EXCEPTIONS-CLIENT
#%{_datadir}/doc/INFO_BIN
#%{_datadir}/doc/INFO_SRC
%{_datadir}/doc/INSTALL-BINARY
%{_datadir}/doc/README

%{_datadir}/doc/COPYING.thirdparty
%{_datadir}/doc/README-wsrep
