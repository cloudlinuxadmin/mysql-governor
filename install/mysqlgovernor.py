...
def build_parser():
    ...
    parser.add_argument("--mysql-version",
                        help="select MySQL version for db-governor. "
                             ...
                             "mariadb100, mariadb101, mariadb102, mariadb103, mariadb104, mariadb105, mariadb106, mariadb107"
                             "percona56",
                        ...
                        choices=['auto', 'mysql51', 'mysql55', 'mysql56',
                                 ...
                                 'mariadb103', 'mariadb104', 'mariadb105', 'mariadb106', 'mariadb107', 'percona56'])
