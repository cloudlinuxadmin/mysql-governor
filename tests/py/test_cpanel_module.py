...
@pytest.mark.parametrize("exception, expected_msg", [
    ('Error!!!', 'Error!!!'),
    ("\nCpanel::Exception::Database::CpuserNotInMap/(XID fh46zu) The cPanel user \xe2\x80\x9cuser1\xe2\x80\x9d does not exist in the database map.\n at /usr/local/cpanel/Cpanel/DB/Map.pm line 223",
