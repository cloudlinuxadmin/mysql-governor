...
echo "creating a new database..."
mysqladmin -umytestsqld -pnewpasswd create mybdd; >/dev/null 2>&1
sleep 5
...
echo "creating a new database..."
mysqladmin -umysqlslaptest -pnewpasswd create pont;
sleep 5
